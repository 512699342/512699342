(function($) {
    $.fn.tip=(function(options) {
        ...
        var _box = $('<div></div>').css({'color':_param.color,'background':_param.bgColor,border:'1px solid '+_param.bdColor,'position':'absolute','padding':'5px 10px','font-size':_param.fontSize}).css('border-radius','4px').html('<div id="tip_message">'+_param.message+'</div>').appendTo($('body'));
